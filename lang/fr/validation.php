...
return [
    ...
    */
    ...
    'custom' => [
        'email_verification_password' => [
            'required' => 'Veuillez saisir votre mot de passe actuel pour confirmer ce changement.',
        ],
        'new_email' => [
            'unique' => 'Cette adresse email est déjà utilisée par un autre compte.',
        ],
        'delete_password' => [
            'required' => 'Veuillez saisir votre mot de passe pour confirmer la suppression du compte.',
        ],
        'logout_other_sessions_password' => [
            'required' => 'Veuillez saisir votre mot de passe pour confirmer la déconnexion des autres sessions.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'email_verification_password' => 'mot de passe actuel',
        'delete_password' => 'mot de passe',
        'logout_other_sessions_password' => 'mot de passe',
    ],
