...
<x-layouts.app>
    <div class="size-full p-20">
        @volt
            <form wire:submit.prevent='login' class="w-full max-w-md mx-auto space-y-5">

                <div>
                    <label for="email">Email</label>
                    <input type="email" id="email" wire:model='email' placeholder="Please enter your email" required>
                    @error('email') 
                ...
                <div>
                    ...
                    <div x-data="{ showPassword: false }" class="relative">
                        <input x-bind:type="showPassword ? 'text' : 'password'" id="password" wire:model='password' placeholder="Please enter your password" required>
                    ...
                    <div class="w-full text-right">
                        <a href="{{ route('password.request') }}" class="w-fit font-medium text-primary underline-offset-2 hover:underline focus:underline focus:outline-hidden dark:text-primaryDark" wire:navigate>Forgot Password ?</a>
                    </div>
