...
<x-layouts.app>
    <div class="size-full p-20 space-y-10">
        ...
        <div class="max-w-2xl mx-auto space-y-12">
                ...
                <form wire:submit.prevent="updateName" class="space-y-5">
                    ...
                    <div class="flex justify-end">
                        <button class="btn-primary" type="submit">
                            <span wire:loading.remove wire:target="updateName">{{ __('Save') }}</span>
                            <span wire:loading wire:target="updateName">{{ __('Saving...') }}</span>
                        </button>
                    </div>
                </form>
            </div>
            ...
            <div class="bg-surface-alt dark:bg-surface-dark-alt p-6 rounded-lg shadow-sm">
                ...
                <form wire:submit.prevent="initiateEmailChange" class="space-y-5">
                    <div>
                        ...
                        <input type="email" id="new_email" wire:model="new_email" placeholder="{{ __('Please enter your new email address') }}" required>
                        @error('new_email')
                        <small class="pl-0.5 text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <div x-data="{ showPassword: false }" class="relative">
                            <input x-bind:type="showPassword ? 'text' : 'password'" id="email_verification_password" wire:model="email_verification_password" placeholder="{{ __('Please enter your current password') }}" required>
                    ...
                    <div class="flex justify-end">
                        <button class="btn-primary" type="submit">
                            <span wire:loading.remove wire:target="initiateEmailChange">{{ __('Update Email') }}</span>
                            <span wire:loading wire:target="initiateEmailChange">{{ __('Updating...') }}</span>
                        </button>
                    </div>
                </form>
            </div>
            ...
            <div x-data="{ showMessage: false }" class="bg-surface-alt dark:bg-surface-dark-alt p-6 rounded-lg shadow-sm">
                ...
                <form wire:submit.prevent="updatePassword" class="space-y-5">
                    <div>
                        ...
                        <div x-data="{ showPassword: false }" class="relative">
                            <input x-bind:type="showPassword ? 'text' : 'password'" id="current_password" wire:model="current_password" placeholder="{{ __('Please enter your current password') }}" required>
                            <button type="button" x-on:click="showPassword = !showPassword" class="absolute right-2.5 top-1/2 -translate-y-1/2 text-on-surface dark:text-on-surface-dark" aria-label="{{ __('Show password') }}">
                                <svg x-show="!showPassword" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" class="size-5">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
            ...
            <div x-data="{ confirmingLogout: false }" class="bg-surface-alt dark:bg-surface-dark-alt p-6 rounded-lg shadow-sm">
                ...
                <div class="flex justify-end">
                    <button type="button" class="btn-outline" @click="confirmingLogout = true">
                        {{ __('Logout from Other Sessions') }}
                    </button>
                </div>

                <!-- Modal for confirmation -->
                <div x-cloak x-show="confirmingLogout" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                    <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                        <!-- Background overlay -->
                        <div x-show="confirmingLogout" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="ease-in duration-200" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="fixed inset-0 transition-opacity bg-gray-500 bg-opacity-75" @click="confirmingLogout = false" aria-hidden="true"></div>

                        <!-- Modal panel -->
                        <div x-show="confirmingLogout" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" x-transition:enter-end="opacity-100 translate-y-0 sm:scale-100" x-transition:leave="ease-in duration-200" x-transition:leave-start="opacity-100 translate-y-0 sm:scale-100" x-transition:leave-end="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" class="inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-surface dark:bg-surface-dark rounded-lg shadow-xl sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                            <div class="sm:flex sm:items-start">
                                <div class="flex items-center justify-center flex-shrink-0 w-12 h-12 mx-auto rounded-full bg-warning/10 sm:mx-0 sm:h-10 sm:w-10">
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <div class="mt-4">
                                            <input type="password" wire:model="logout_other_sessions_password" class="w-full" placeholder="{{ __('Password') }}" />
                            ...
                            <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                                <button type="button" class="btn-warning w-full sm:ml-3 sm:w-auto" wire:click="logoutOtherBrowserSessions">
                                    <span wire:loading.remove wire:target="logoutOtherBrowserSessions">{{ __('Logout Other Browser Sessions') }}</span>
                                    <span wire:loading wire:target="logoutOtherBrowserSessions">{{ __('Processing...') }}</span>
                                </button>
                                <button type="button" class="btn-outline mt-3 w-full sm:mt-0 sm:w-auto" @click="confirmingLogout = false">
                                    {{ __('Cancel') }}
                                </button>
                            </div>
                        </div>
            ...
            <div x-data="{ confirmingDelete: false }" class="bg-danger/5 dark:bg-danger-dark/5 p-6 rounded-lg shadow-sm">
                ...
                <div class="flex justify-end">
                    <button type="button" class="btn-danger" @click="confirmingDelete = true">
                        {{ __('Delete Account') }}
                    </button>
                </div>

                <!-- Modal for confirmation -->
                <div x-cloak x-show="confirmingDelete" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                    <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                        <!-- Background overlay -->
                        <div x-show="confirmingDelete" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="ease-in duration-200" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="fixed inset-0 transition-opacity bg-gray-500 bg-opacity-75" @click="confirmingDelete = false" aria-hidden="true"></div>

                        <!-- Modal panel -->
                        <div x-show="confirmingDelete" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" x-transition:enter-end="opacity-100 translate-y-0 sm:scale-100" x-transition:leave="ease-in duration-200" x-transition:leave-start="opacity-100 translate-y-0 sm:scale-100" x-transition:leave-end="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" class="inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-surface dark:bg-surface-dark rounded-lg shadow-xl sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                            <div class="sm:flex sm:items-start">
                                <div class="flex items-center justify-center flex-shrink-0 w-12 h-12 mx-auto rounded-full bg-danger/10 sm:mx-0 sm:h-10 sm:w-10">
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <div class="mt-4">
                                            <input type="password" wire:model="delete_password" class="w-full" placeholder="{{ __('Password') }}" />
                            ...
                            <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                                <button type="button" class="btn-danger w-full sm:ml-3 sm:w-auto" wire:click="deleteAccount">
                                ...
                                <button type="button" class="btn-outline mt-3 w-full sm:mt-0 sm:w-auto" @click="confirmingDelete = false">
                                    {{ __('Cancel') }}
                                </button>
                            </div>
                        </div>
